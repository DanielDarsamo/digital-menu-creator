-- Phase 5: Waiter Order Flow Redesign - FIXED
...
-- 1. Drop the problematic RLS policies first
...
-- 4. Ensure accepted_at column exists
ALTER TABLE public.orders 
ADD COLUMN IF NOT EXISTS accepted_at TIMESTAMPTZ;

-- 5. Create status transition validation function
...
-- 6. Create trigger to enforce status transitions
...
-- 8. Re-create RLS policies with proper role checks
...
-- Waiters can update orders they've accepted
...
-- 10. Update order_statistics view to include payment type breakdown
